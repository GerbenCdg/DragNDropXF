using DragNDropXF.Droid.CustomRenderers;
using SkiaSharp;
using System;
using Xamarin.Forms;
...
{
    [RenderWith(typeof(SKCanvasStackLayoutRenderer))]
    public class SKCanvasStackLayout : StackLayout, ISKCanvasViewController
    {
        public static readonly BindableProperty IgnorePixelScalingProperty =
             BindableProperty.Create(nameof(IgnorePixelScaling), typeof(bool), typeof(SKCanvasStackLayout), false);

        public static readonly BindableProperty EnableTouchEventsProperty =
            BindableProperty.Create(nameof(EnableTouchEvents), typeof(bool), typeof(SKCanvasStackLayout), false);
